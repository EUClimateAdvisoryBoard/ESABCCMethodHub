...
--
-- No 2024 or 2025 point is added: air passenger-kilometres for the EU are a
-- DG MOVE estimate published only in this pocketbook, and the current (2025)
-- edition's series ends at 2023. Eurostat's aviation tables (avia_pao*) do run
-- to 2025 but carry passengers and flights, not passenger-kilometres. The
-- source label now states the edition and its latest data year so the chart
-- stopping at 2023 reads as "the source ends here", not as missing data.
--
