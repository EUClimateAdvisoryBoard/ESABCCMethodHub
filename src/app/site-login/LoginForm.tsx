        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          ...
          >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-gradient-to-r from-[#004B7F] to-[#007B6C] text-white py-3 rounded-lg font-medium text-sm hover:opacity-90 transition shadow-lg disabled:opacity-60"
            >
