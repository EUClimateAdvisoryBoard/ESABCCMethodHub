 ...
 *
 * It also renders a ribbon of twelve beta modules routed under `/beta/<slug>`.
 *
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#3D5265]">
      ...
      {/* ─────────────────────────────────────────────────────────
          BETA MODULES  (M·09 – M·20)
          Twelve experimental modules routed under `/beta/<slug>`. Each card
        ...
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-[13px] text-[#3D5265]/75 leading-relaxed">
              Twelve experimental modules live under <code className="font-mono text-[12px] bg-[#FBFBFA] border border-[#E6E7E8] px-1.5 py-0.5 rounded-sm">beta/modules/</code> and are exposed at <code className="font-mono text-[12px] bg-[#FBFBFA] border border-[#E6E7E8] px-1.5 py-0.5 rounded-sm">/beta/&lt;slug&gt;</code>.
