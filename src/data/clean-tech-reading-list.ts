...
export const CLEAN_TECH_READING_LIST: CleanTechReadingSeed[] = [
  ...
  {
    id: 'reading-ct-42',
    source: 'Hörbe Emanuelsson, A., Rootzén, J., Johnsson, F.',
    title: 'Deployment of carbon capture and storage in the cement industry — is the EU up to shape? (Int. J. Greenhouse Gas Control)',
    year: '2025',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.ijggc.2025.104442',
  },
  {
    id: 'reading-ct-43',
    source: 'Volaity, S.S., et al.',
    title: 'Towards decarbonization of cement industry: a critical review of electrification technologies (npj Materials Sustainability)',
    year: '2025',
    reader: 'Pieter',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1038/s44296-025-00068-6',
  },
  {
    id: 'reading-ct-44',
    source: 'Mynko, O., Bonheure, M., … Van Geem, K.M.',
    title: 'Electrification of steam cracking as a pathway to reduce petrochemical climate impact (J. Cleaner Production)',
    year: '2023',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.jclepro.2023.139208',
  },
  {
    id: 'reading-ct-45',
    source: 'Foslie, S.S., Straus, J., Knudsen, B.R., Korpås, M.',
    title: 'Decarbonizing integrated chlor-alkali and VCM production with industrial flexibility (Advances in Applied Energy)',
    year: '2023',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.adapen.2023.100152',
  },
  {
    id: 'reading-ct-46',
    source: 'Salman, M., Flórez-Orrego, D., … Léonard, G.',
    title: 'Decarbonising the glass industry: a techno-economic assessment of low-emission pathways (Computers & Chemical Engineering)',
    year: '2025',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.compchemeng.2025.109329',
  },
  {
    id: 'reading-ct-47',
    source: 'Joyo, F.H., Nastasi, B., Astiaso Garcia, D.',
    title: 'Decarbonization pathways for the pulp and paper industry: a comprehensive review (Renewable & Sustainable Energy Reviews)',
    year: '2025',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.rser.2025.116070',
  },
  {
    id: 'reading-ct-48',
    source: 'Jiang, J., Hu, B., Wang, R.Z., et al.',
    title: 'A review and perspective on industry high-temperature heat pumps (Renewable & Sustainable Energy Reviews)',
    year: '2022',
    reader: 'Kamila',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.rser.2022.112106',
  },
  {
    id: 'reading-ct-49',
    source: 'Vriz, G.L., Cojoianu, T., Fischer, C., Taschini, L.',
    title: 'Early signs the EU CBAM is reshaping EU–India steel trade (Nature Climate Change)',
    year: '2026',
    reader: 'Ciarán',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1038/s41558-026-02607-y',
  },
  {
    id: 'reading-ct-50',
    source: 'Watari, T., Cao, Z., Hata, S., Nansai, K.',
    title: 'Efficient use of cement and concrete to reduce reliance on supply-side technologies for net-zero (Nature Communications)',
    year: '2022',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1038/s41467-022-31806-2',
  },
  {
    id: 'reading-ct-51',
    source: 'Lima, A.T., Kirkelund, G.M., … Simoes, S.G.',
    title: 'Mapping circular-economy practices for steel, cement, glass, brick, insulation and wood (Renewable & Sustainable Energy Reviews)',
    year: '2024',
    reader: '',
    tier: 'scientific',
    chapter: C,
    url: 'https://doi.org/10.1016/j.rser.2024.114697',
  },
  {
    id: 'reading-ct-52',
    source: 'Tumara, D., Uihlein, A., Hidalgo González, I. (JRC)',
    title: 'Shaping the future CO₂ transport network for Europe',
    year: '2024',
    reader: '',
    tier: 'grey',
    chapter: C,
    url: 'https://publications.jrc.ec.europa.eu/repository/handle/JRC136709',
  },
  {
    id: 'reading-ct-53',
    source: 'IEA',
    title: 'Demand and Supply Measures for the Steel and Cement Transition',
    year: '2024',
    reader: '',
    tier: 'grey',
    chapter: C,
    url: 'https://www.iea.org/reports/demand-and-supply-measures-for-the-steel-and-cement-transition',
  },
];
