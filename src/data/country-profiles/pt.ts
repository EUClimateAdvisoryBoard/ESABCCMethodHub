...
const pt: CountryProfile = {
  ...
  ghg: {
    totalLatest: { value: 53.5, unit: 'Mt CO2e', year: 2023, source: 'APA / UNFCCC' },
    total1990: 60.2,
    perCapita: { value: 5.1, unit: 't CO2e/cap', year: 2023, source: 'EEA' },
    perGdp: { value: 0.22, unit: 'kg CO2e/€', year: 2023, source: 'EEA' },
  ...
  renewables: {
    shareLatest: { value: 35.0, unit: '%', year: 2023, source: 'DGEG / Eurostat' },
    share2005: 19.5,
    share2020: 34.0,
    target2030: 51,
    bySubsector: [
  ...
  efficiency: {
    primary: { value: 21.5, unit: 'Mtoe', year: 2022 },
    final:   { value: 16.4, unit: 'Mtoe', year: 2022 },
  ...
  air: {
    pm25: { value: 8.5, unit: 'µg/m³', year: 2022 },
    no2:  { value: 13.0, unit: 'µg/m³', year: 2022 },
    ozone: { value: 41.2, unit: 'µg/m³ (SOMO35)', year: 2022 },
    prematureDeaths: { value: 2900, unit: 'deaths/yr (PM2.5)', year: 2021, source: 'EEA' },
    exceedanceShare: { value: 90, unit: '% urban pop > WHO 5 µg/m³', year: 2022 },
    narrative:
  ...
  water: {
    ...
    drinkingWaterCompliance: { value: 98.7, unit: '%', year: 2022 },
    narrative:
  ...
  biodiversity: {
    natura2000Land: { value: 22.4, unit: '% land', year: 2023 },
    natura2000Marine: { value: 7.6, unit: '% EEZ', year: 2023 },
    threatenedSpecies: { value: 660, unit: 'IUCN red-list', year: 2022 },
    habitatsFavourable: { value: 23, unit: '%', year: 2019, source: 'Art. 17 reporting' },
    narrative:
  ...
  circular: {
    municipalRecycling: { value: 31, unit: '%', year: 2022 },
    circularMaterialUseRate: { value: 2.4, unit: '%', year: 2022 },
