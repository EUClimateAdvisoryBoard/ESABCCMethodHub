...
const sk: CountryProfile = {
  ...
  ghg: {
    totalLatest: { value: 39, unit: 'Mt CO2e', year: 2022, source: 'UNFCCC / EEA' },
    total1990: 73,
    perCapita: { value: 7.1, unit: 't CO2e/cap', year: 2022, source: 'EEA' },
  ...
  renewables: {
    shareLatest: { value: 17.5, unit: '%', year: 2022, source: 'Eurostat SHARES' },
    share2005: 6.4,
    share2020: 17.3,
    target2030: 23,
    bySubsector: [
  ...
  efficiency: {
    primary: { value: 16.0, unit: 'Mtoe', year: 2022 },
    final:   { value: 11.7, unit: 'Mtoe', year: 2022 },
  ...
  air: {
    ...
    no2:  { value: 18.7, unit: 'µg/m³', year: 2022 },
    ozone: { value: 64.2, unit: 'µg/m³ (SOMO35)', year: 2022 },
    prematureDeaths: { value: 4900, unit: 'deaths/yr (PM2.5)', year: 2021, source: 'EEA' },
  ...
  water: {
    surfaceWaterGood: { value: 54, unit: '%', year: 2021, source: 'WISE-WFD' },
    groundwaterGood: { value: 81, unit: '%', year: 2021 },
    bathingWaterExcellent: { value: 84, unit: '%', year: 2023 },
  ...
  biodiversity: {
    natura2000Land: { value: 30.0, unit: '% land', year: 2023 },
    threatenedSpecies: { value: 320, unit: 'IUCN red-list', year: 2022 },
    habitatsFavourable: { value: 26, unit: '%', year: 2019, source: 'Art. 17 reporting' },
    protectedAreas: { value: 22.7, unit: '% land', year: 2023 },
    narrative:
  ...
  circular: {
    municipalRecycling: { value: 49, unit: '%', year: 2022 },
    circularMaterialUseRate: { value: 5.5, unit: '%', year: 2022 },
