...
const lv: CountryProfile = {
  ...
  ghg: {
    totalLatest: { value: 10.9, unit: 'Mt CO2e', year: 2022, source: 'EEA / UNFCCC' },
    total1990: 25.4,
    perCapita: { value: 5.8, unit: 't CO2e/cap', year: 2022, source: 'EEA' },
  ...
  renewables: {
    shareLatest: { value: 43.3, unit: '%', year: 2022, source: 'Eurostat SHARES' },
    share2005: 32.2,
    share2020: 42.1,
    target2030: 57,
    bySubsector: [
  ...
  efficiency: {
    primary: { value: 4.8, unit: 'Mtoe', year: 2022 },
    final:   { value: 4.4, unit: 'Mtoe', year: 2022 },
    intensity: { value: 146, unit: 'kgoe/1000 EUR (2015)', year: 2022 },
    target2030: -18,
    narrative:
  ...
  air: {
    ...
    ozone: { value: 41.8, unit: 'µg/m³ (SOMO35)', year: 2022 },
    prematureDeaths: { value: 1300, unit: 'deaths/yr (PM2.5)', year: 2021, source: 'EEA' },
    exceedanceShare: { value: 91, unit: '% urban pop > WHO 5 µg/m³', year: 2022 },
    narrative:
  ...
  water: {
    ...
    groundwaterGood: { value: 100, unit: '%', year: 2021 },
    bathingWaterExcellent: { value: 73, unit: '%', year: 2023 },
  ...
  biodiversity: {
    natura2000Land: { value: 11.5, unit: '% land', year: 2023 },
    natura2000Marine: { value: 16.0, unit: '% EEZ', year: 2023 },
    threatenedSpecies: { value: 580, unit: 'IUCN red-list', year: 2022 },
    habitatsFavourable: { value: 30, unit: '%', year: 2019, source: 'Art. 17 reporting' },
    narrative:
  ...
  circular: {
    municipalRecycling: { value: 44, unit: '%', year: 2022 },
