...
const es: CountryProfile = {
  ...
  ghg: {
    totalLatest: { value: 275, unit: 'Mt CO2e', year: 2023, source: 'MITECO / UNFCCC' },
    total1990: 288,
    perCapita: { value: 5.7, unit: 't CO2e/cap', year: 2023, source: 'EEA' },
  ...
  renewables: {
    shareLatest: { value: 24.1, unit: '%', year: 2023, source: 'MITECO' },
    share2005: 8.4,
    share2020: 21.2,
    target2030: 48,
    bySubsector: [
  ...
  efficiency: {
    primary: { value: 116, unit: 'Mtoe', year: 2022 },
    final:   { value: 85, unit: 'Mtoe', year: 2022 },
  ...
  air: {
    ...
    ozone: { value: 62.1, unit: 'µg/m³ (SOMO35)', year: 2022 },
    prematureDeaths: { value: 23000, unit: 'deaths/yr (PM2.5)', year: 2021, source: 'EEA' },
    exceedanceShare: { value: 89, unit: '% urban pop > WHO 5 µg/m³', year: 2022 },
    narrative:
  ...
  water: {
    ...
    groundwaterGood: { value: 65, unit: '%', year: 2021 },
    bathingWaterExcellent: { value: 88, unit: '%', year: 2023 },
  ...
  biodiversity: {
    ...
    natura2000Marine: { value: 12, unit: '% EEZ', year: 2023 },
    threatenedSpecies: { value: 2890, unit: 'IUCN red-list', year: 2022 },
  ...
  circular: {
    ...
    circularMaterialUseRate: { value: 7.1, unit: '%', year: 2022 },
    resourceProductivity: { value: 2.5, unit: '€/kg', year: 2022 },
    narrative:
