...
export const SEED_COUNCILS: ClimateCouncil[] = [
  ...
  // 3. Austria APCC
  {
    ...
    level: 'national', region: '',
    status: 'inter_ministerial', established: '2011 (CCCA) / 2014 (APCC)', statutory: 'Secondary',
    url: 'https://ccca.ac.at/en/', legalBasisUrl: 'https://ccca.ac.at/en/home/',
    notes: 'Research network — CCCA founded 18 Jul 2011; APCC constituted within CCCA in 2014 with publication of first Austrian Assessment Report (AAR14). NOT a statutory advisory body.',
  ...
  // 22. Hungary Ombudsman
  {
    ...
    level: 'national', region: '',
    status: 'active_statutory', established: '2008 (constituted 1 Oct) / 2011 (Article P constitutionalised) / 2012 (re-constituted as Deputy Commissioner)', statutory: 'Yes',
  ...
  // 30. Poland
  {
    ...
    notes: 'Poland has NO framework climate law and NO dedicated climate council; no framework law under Tusk government either. EU launched infringement proceedings October 2025 over missing climate plan.',
  ...
  // 33. Romania CCDD
  {
    ...
    level: 'national', region: '',
    status: 'partial_proxy', established: '2020', statutory: '',
    url: 'https://dezvoltaredurabila.gov.ro/ccdd',
    legalBasisUrl: 'https://dezvoltaredurabila.gov.ro/ccdd',
  ...
  // 36. Slovenia
  {
    ...
    notes: 'Strongest SE European body; 9 members (4 nominated by public universities, 3 by SAZU, 2 by NGOs); 6-year mandate.',
  ...
  // 42. Vienna
  {
    ...
    status: 'active_statutory', established: '2019 / 2025 (statutory anchoring)', statutory: 'Yes',
  ...
  // 44. Flanders
  {
    ...
    status: 'partial_proxy', established: '1991 / 2004 (SAR reform)', statutory: 'Yes',
  ...
  // 45. Wallonia
  {
    ...
    notes: 'Substantially reinforced by 16 Nov 2023 Carbon Neutrality Decree; jury-based selection; composition expanded from 7 to 10 members. Closely associated with Plateforme wallonne pour le GIEC (Jean-Pascal van Ypersele).',
  ...
  // 46. Other Länder
  {
    ...
    notes: 'Germany has dense Länder-level climate council architecture — most active in EU. Niedersachsen Klimarat only formally constituted in H2 2025 (15 members) following the 2024 settlement with DUH.',
  ...
  // 47. Baden-Württemberg
  {
    ...
    notes: 'Strongest German sub-national body; built on KSG model. 6 scientists (Schmidt, Schindler, Arneth, Pehnt, Löbbe, Kesselring).',
  ...
  // 48. Brandenburg
  {
    ...
    status: 'active_no_statute', established: '2024', statutory: '',
    url: 'https://mluk.brandenburg.de/',
    legalBasisUrl: 'https://mluk.brandenburg.de/',
    notes: '12-member body chaired by Hermann Lotze-Campen (PIK); founded under Brandenburg Klimaplan March 2024, constituted 15 July 2024.',
  ...
  // 50. Hesse
  {
    ...
    notes: 'Standard German KSG model. Appointed April 2023 under Hessian Climate Act of January 2023.',
  ...
  // 55. Basque
  {
    ...
    legalBasisUrl: 'https://www.boe.es/buscar/act.php?id=BOE-A-2024-4783',
    notes: 'Under Basque Ley 1/2024 of 8 Feb 2024 (Transición Energética y Cambio Climático), which establishes a Comité Científico de Transición Energética y Cambio Climático (6 experts, parliamentary appointment); BC3 provides scientific input ecosystem.',
  ...
  // 60. Cyprus
  {
    ...
    url: '',
    legalBasisUrl: 'https://www.europarl.europa.eu/thinktank/en/document/EPRS_BRI(2025)769495',
    notes: 'Weakest institutional case in EU27. Terra Cypria NGO and others advocate for framework climate law with advisory-body provisions. Constitutional amendment Dec 2024 introduced right to a healthy environment but did not create an advisory body. Climate Law still in preparation under 2025 government programme.',
  ...
  // 61. Czechia
  {
    ...
    notes: 'Pirate Party draft climate law of Nov 2023 (proposing independent Klimatická rada) was not adopted before Oct 2025 elections. New ANO-SPD-Motorists government (Babiš sworn in 9 Dec 2025) is climate-sceptic; framework climate law and Klimatická rada now further from adoption.',
  ...
  // 63. Latvia
  {
    ...
    bodyName: 'NONE — draft Climate Law not yet adopted',
    bodyOriginal: '',
    level: 'national', region: '',
    status: 'none', established: '', statutory: '',
    url: '',
  ...
  // 66. Slovakia
  {
    ...
    notes: 'Environment Ministry draft Climate Act of January 2023 (proposing Rada pre klimatickú zodpovednosť) halted after Fico government returned in October 2023. May 2025 NKÚ audit ("As the Earth Warms…") recommended Parliament resume drafting; still no climate law adopted as of 2026.',
