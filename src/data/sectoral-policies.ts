...
export interface SectorPolicy {
  ...
  sectors: SectorId[];
  /**
   * High-level category distinguishing individual enacted legal acts
   * ('legislation') from multi-act umbrella packages ('package') and
   * non-binding strategies / communications / action plans ('plan').
   */
  policyType: 'legislation' | 'package' | 'plan';
