  ...
  return (
    <section className="border-b border-[#E6E7E8] bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-6 sm:py-8 lg:py-12">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-[12px] sm:text-[13px] text-[#E87722] hover:text-[#c45f14] active:text-[#c45f14] transition mb-3 sm:mb-4 py-1 -ml-1 pl-1 touch-target"
        >
        ...
        <h1 className="text-[20px] sm:text-[24px] lg:text-[30px] font-bold text-[#3D5265] leading-tight">
          <span className="inline border-b-2 border-[#00928F] pb-1">{title}</span>
        </h1>
        {subtitle && (
          <p className="mt-3 sm:mt-4 text-[13px] sm:text-[14px] text-[#3D5265]/75 max-w-2xl leading-relaxed">
            {subtitle}
          </p>
        )}
