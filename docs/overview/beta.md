...
| M·47  | `competitiveness-claims/`    | Competitiveness Claims Register | 14 claims from the competitiveness debate, balanced 7/7 by direction, decomposed into propositions with verdict bands and machine-checked steel-mans. 8 of 14 carry the speaker's own words verbatim, revalidated as exact substrings by `npm run check:claims`; the rest say why not. Verdicts AI-drafted and politically sensitive; Secretariat sign-off required. |
