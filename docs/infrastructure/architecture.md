...
| `beta/modules/` | Thirty-five experimental modules, **unrouted**. | Outside the `app/` tree, so the build ignores them. Promotion = move a folder back into `src/app/` (this is how M·07 and M·08 graduated). |
