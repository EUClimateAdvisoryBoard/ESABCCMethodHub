...
| `transition-stories-2/`       | Transition Stories 2 — Mind the Gap | Cinematic landing page for the policy gap report (*Towards EU climate neutrality*, 2024): scroll-shaded gap chart, living SVG scenes (water, embers, cattle, cyclist, turbines) over real report photography, sector gap ledger, the 13 key recommendations. |
