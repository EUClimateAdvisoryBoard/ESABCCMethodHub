...
| `ets-wishlist-impact/`        | ETS Wishlist — GHG Impact | Two linked tools quantifying the GHG cost of the EPP's ten-point "wishlist" to soften the EU ETS (slower LRF, weaker MSR, removal & international credits, slower CBAM free-allowance phase-out, free allocation beyond 2030, looser benchmarks, conditional free permits, ETS-revenue earmarking, intra-EU-only aviation). **(1) Accounting model** (main page): each demand modelled one-by-one and combined, Conservative/Central/Maximalist scenarios, net setback expressed as years of EU progress lost and as a share of the ESABCC-advised 2030–2050 budget; a full scientific-methodology section ties every lever to its equation, calibrated value (LRF reference = 2008–2012 avg cap ≈1.95 Gt → ≈86 Mt/yr, 1 pp ≈19.5 Mt/yr; extra-EU aviation ≈107 Mt/yr; CDM non-additionality 73% per Cames 2016) and primary source. **(2) Market model** (`/market` subpage): solves a reduced-form intertemporal banking (Hotelling) equilibrium with an MSR waterbed-puncture, comparing the legislated vs wishlist cap to derive the carbon-price drop, banking trajectory and endogenous extra emissions (Hotelling 1931; Rubin 1996; Schennach 2000; Perino & Willner 2016; Perino 2018). Honest core: cap/supply demands drive real extra cumulative emissions; free-allocation demands are near-neutral on the capped total. All numbers verified against EUR-Lex, ICAP, UBA/DEHSt, EEA, T&E and ESABCC; teaching reconstruction, not LIMES-EU/PRIMES. |
