        ...
        <section className="mb-8">
          <div className="rounded-lg border border-grey-200 dark:border-[var(--mh-border)] bg-white dark:bg-[var(--mh-card)] p-4">
            ...
            <div className="mt-4 text-[12.5px] leading-relaxed text-tertiary dark:text-[var(--mh-muted)] space-y-2">
              ...
              <p>
                Water ({overall.bySector.find((s) => s.key === 'water')?.n}) and health ({overall.bySector.find((s) => s.key === 'health')?.n}) — the two adaptation-critical systems — remain thinly covered, and what exists there is mostly indicative (Water Resilience Strategy, Zero Pollution Action Plan). Almost all quantified, binding milestones across sectors cluster on 2030; beyond it the register thins to the 2040 climate target, the 2035 zero-emission vehicle dates, the aviation/maritime fuel trajectories to 2050, and the restoration and building-stock endpoints in 2050 — visible in each sector's timeline below.
              </p>
            </div>
          </div>
        </section>
