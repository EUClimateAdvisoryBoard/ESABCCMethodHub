      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-5 py-5">
        ...
        <details className="mb-4 rounded-lg border border-grey-200 dark:border-[var(--mh-border)] bg-white dark:bg-[var(--mh-card)] p-3.5 text-[12.5px] text-tertiary dark:text-[var(--mh-muted)]">
          ...
          <div className="mt-2.5 space-y-2 leading-relaxed">
            <p><strong>Scope.</strong> The register covers the <strong>climate-relevant subset of the Policy Navigator&rsquo;s registry</strong> (M·04, {stats.policies} of its 97 acts): every act whose enacting terms set a target, goal, objective or commitment bearing on climate mitigation or adaptation — the core climate architecture (Climate Law, ETS, ESR, LULUCF, F-gas, Nature Restoration) plus the Fit-for-55 / Green Deal delivery acts across energy, transport, industry, buildings, circular economy, land &amp; water, and sustainable finance. It is <em>not</em> the whole acquis and <em>not</em> one target per area; acquis with no climate-target content (digital, health, security, migration, justice, consumer, education) is out of scope. Because the pick follows the Navigator&rsquo;s domain tags it is reproducible and auditable (<code>npm&nbsp;run&nbsp;check:policy-targets-coverage</code>).</p>
