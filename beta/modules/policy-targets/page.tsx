      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-5 py-5">
        ...
        <details className="mb-4 rounded-lg border border-grey-200 dark:border-[var(--mh-border)] bg-white dark:bg-[var(--mh-card)] p-3.5 text-[12.5px] text-tertiary dark:text-[var(--mh-muted)]">
          ...
          <div className="mt-2.5 space-y-2 leading-relaxed">
            ...
            <p><strong>Obligation</strong> is read from the instrument type (regulations/directives/decisions bind; communications/strategies are soft law) and the modal verb (&ldquo;shall&rdquo; → mandatory, &ldquo;should&rdquo;/&ldquo;may&rdquo; → voluntary). It reports the obligation created by <em>the act the row belongs to</em>: a soft-law row is always voluntary, even where the passage quotes binding text that lives in another act, and best-efforts wording in a binding act (&ldquo;shall endeavour / aim / make all appropriate efforts&rdquo;) counts as voluntary. <strong>Type</strong> is quantitative when a number/%/date threshold is present, else qualitative. <strong>Climate-relevance</strong> flags mitigation and/or adaptation.</p>
