 ...
 * divisions 10–33), organised as ONE summary dashboard (Overview) plus a
 ...
 * inputs, and the division's own risk hotspots. The full FIGARO inter-country
      ...
      <main className="mx-auto max-w-wide px-4 py-8">
        ...
        <header className="mb-6">
          ...
          <p className="mt-2 max-w-text text-grey-700">
            ...
            10–33), in two reading modes. The <span className="font-semibold">Overview</span> is one summary
            dashboard: headline facts, the imports-vs-exports balance of all 24 divisions, the{' '}
            <span className="font-semibold text-accent-red">high-risk hotspots</span> where imports are both
            large and concentrated in a single supplier, and the critical-materials board. From there, pick
            ...
            inputs and its own risk hotspots — all in one place. The full FIGARO table itself now{' '}
