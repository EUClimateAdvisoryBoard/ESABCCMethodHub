...
export const CRITICAL_MATERIALS: CriticalMaterial[] = [
  ...
  { material: 'Natural graphite', strategic: true, euImportReliance: 100, topSupplier: 'China', supplierShare: 43, usedIn: 'Li-ion battery anodes, refractories (C27, C29)', note: 'China ~43% of EU imports (2025 trade data); dominant in spherical/processed graphite', src: { org: 'Eurostat', title: 'International trade in critical raw materials', url: 'https://ec.europa.eu/eurostat/statistics-explained/index.php?title=International_trade_in_critical_raw_materials', year: '2026' } },
  { material: 'Gallium', strategic: true, euImportReliance: 100, topSupplier: 'China', supplierShare: 77, usedIn: 'Semiconductors, LEDs, GaN/RF chips (C26)', note: 'China ~77% of EU imports (2025 trade data), ~80–90% of global refined; export-controlled since 2023', src: { org: 'Eurostat', title: 'International trade in critical raw materials', url: 'https://ec.europa.eu/eurostat/statistics-explained/index.php?title=International_trade_in_critical_raw_materials', year: '2026' } },
...
export const RISK_HOTSPOTS: RiskHotspot[] = [
  ...
  { label: 'Gallium (chip feedstock)', naceDivision: 'C26', importReliance: 1.0, supplierConcentration: 0.77, supplier: 'China', src: { org: 'Eurostat', title: 'International trade in critical raw materials', url: 'https://ec.europa.eu/eurostat/statistics-explained/index.php?title=International_trade_in_critical_raw_materials', year: '2026' } },
  ...
  { label: 'Natural graphite (anodes)', naceDivision: 'C27/C29', importReliance: 1.0, supplierConcentration: 0.43, supplier: 'China', src: { org: 'Eurostat', title: 'International trade in critical raw materials', url: 'https://ec.europa.eu/eurostat/statistics-explained/index.php?title=International_trade_in_critical_raw_materials', year: '2026' } },
